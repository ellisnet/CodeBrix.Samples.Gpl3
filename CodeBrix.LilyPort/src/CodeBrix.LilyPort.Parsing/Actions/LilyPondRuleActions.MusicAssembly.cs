...
/// <content>
/// Core music assembly: <c>music_list</c>,
...
/// <c>basic_music</c>, <c>contexted_basic_music</c> (where the ContextDefinitions group's
...
{
    private static void RegisterMusicAssembly(RuleActionTable table)
    {
        ...
        //     $$ = n->unprotect (); }
        //
        // THE TWIN of the EmbeddedScheme group's `embedded_lilypond: duration post_events %prec ':'`,
        ...
        //
        // The FINISH_MAKE_SYNTAX side of the ContextDefinitions group's context_prefix: the prefix value is
