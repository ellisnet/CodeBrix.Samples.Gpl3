...
/// <content>
/// RULE ACTION GROUP 9 — music-function arglists, the BACKUP half:
...
{
    private static void RegisterRag9(RuleActionTable table)
    {
        ...
        //             MYBACKUP (UNSIGNED, $4, @4); } } }
        //
        // RAG8's UNSIGNED ladder, except that the trigger-error rungs are BACKUPS
        ...
        //                                $1, $2); }
        //
        // Unlike RAG8's twin, no display argument — upstream passes none here.
        table.Add(
            "function_arglist_backup: function_arglist_backup REPARSE pitch_or_music",
            (context, values, locations, location) =>
            {
