...
/// <content>
/// Music-function arglists, the COMMON half, the skip/partial
...
/// <c>LYRIC_ELEMENT</c> where the nonbackup twin (the ArglistNonBackup group) uses <c>STRING</c>.
/// </para>
/// </content>
public static partial class LilyPondRuleActions
{
    private static void RegisterArglistCommon(RuleActionTable table)
    {
        ...
        // eventually called (the PartialFunctions group / the TopLevel group's partial-music-function).
        ...
        //
        // the ArglistNonBackup group's reparse family in FINAL-ARGUMENT position: EXPECT_SCM is $1, the
        ...
        //     the ArglistNonBackup group's UNSIGNED ladder in final position — every rung reparses. }
        table.Add(
            "function_arglist_common_reparse: EXPECT_SCM function_arglist_optional UNSIGNED",
            (context, values, locations, location) =>
            {
