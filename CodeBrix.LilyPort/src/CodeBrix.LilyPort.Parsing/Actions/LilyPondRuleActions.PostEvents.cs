...
/// <content>
/// Post events, scripts and text attachments: everything
...
{
    private static void RegisterPostEvents(RuleActionTable table)
    {
        ...
        RegisterPostEventScripts(table);
    }

    // direction_reqd_event and the two token families that feed it.
    private static void RegisterPostEventScripts(RuleActionTable table)
    {
