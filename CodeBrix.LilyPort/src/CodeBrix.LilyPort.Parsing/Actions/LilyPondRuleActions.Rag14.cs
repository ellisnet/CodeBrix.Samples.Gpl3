...
/// <content>
/// RULE ACTION GROUP 14 — chords and event chords. TWO different things share the
...
{
    private static void RegisterRag14(RuleActionTable table)
    {
        ...
        //
        // The figured-bass shape (RAG17 builds figure_list): a plain reverse, with no
        ...
        RegisterRag14ChordBodyElements(table);
        RegisterRag14ChordNames(table);
    }

    // The written note events inside < >, plus the event-function call.
    private static void RegisterRag14ChordBodyElements(RuleActionTable table)
    {
        ...
        //     $$ = n->unprotect (); }
        //
        // RAG16's pitch_or_music without the duration: inside a chord the elements
        ...
        //
        // The same constructor RAG10's music_function_call uses; the token differs
    ...
    private static void RegisterRag14ChordNames(RuleActionTable table)
    {
        ...
        //
        // A bare root with no duration stays a PITCH — RAG16's
