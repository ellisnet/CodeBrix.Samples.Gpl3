...
/// <content>
/// RULE ACTION GROUP 12 — mode changes and lyric mode: <c>optional_id</c>,
...
{
    private static void RegisterRag12(RuleActionTable table)
    {
        ...
        // } %prec ':'
        //
        // unsmob<Music> is the direct Engine cast (the RAG1/RAG5 convention): the
