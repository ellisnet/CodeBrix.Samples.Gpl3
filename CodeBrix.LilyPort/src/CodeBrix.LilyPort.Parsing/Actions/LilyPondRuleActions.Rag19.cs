...
/// <content>
/// RULE ACTION GROUP 19 — markup COMMANDS and their argument lists, and the last of
...
/// <c>simple_markup_noword: MARKUP_FUNCTION ...</c> in RAG18).
/// </para>
/// <para>
...
/// expectation. It is RAG11's partial-function mechanism, in markup.
/// </para>
/// </content>
public static partial class LilyPondRuleActions
{
    private static void RegisterRag19(RuleActionTable table)
    {
        ...
        // arguments, put back into written order. The single-markup twin is RAG18's
        ...
        // length — RAG8-RAG10's shared helper, unchanged.
        table.Add(
        ...
        // applied innermost-first — the same shape RAG11's partial_function builds for
        // music functions.
        table.Add(
            "markup_partial_function: MARKUP_FUNCTION markup_arglist_partial",
            (context, values, locations, location)
