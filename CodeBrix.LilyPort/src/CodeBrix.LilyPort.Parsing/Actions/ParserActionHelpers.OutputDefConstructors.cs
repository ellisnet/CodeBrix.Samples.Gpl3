...
/// <content>
/// The output-definition helpers the OutputDefinitions group's rules drive: the three
...
/// <see cref="SetPaper"/>) is in the PaperStack file — plus <c>assign_context_def</c> from
/// <c>output-def.cc</c>, the one helper this group calls that upstream keeps in a
/// third file. Ported over the host seam like the paper-stack helpers; upstream's
