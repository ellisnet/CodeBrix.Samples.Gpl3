...
/// <content>
/// The helpers the MusicAssembly group brought in: the <c>FINISH_MAKE_SYNTAX</c> macro
/// (the applying half of the ContextDefinitions group's <c>START_MAKE_SYNTAX</c>), and the epilogue's
...
{
    /// <summary>
    /// Applies a constructor list built by <c>START_MAKE_SYNTAX</c> (the ContextDefinitions group's
    ...
    /// explicitly here; the PitchesAndDurations group's duration rules are the callers that vary them.</para>
    /// </summary>
