...
/// <content>
/// RULE ACTION GROUP 11 — partial functions, <c>\etc</c>:
...
/// collected so far, and RAG1's <c>identifier_init_nonumber: partial_function ETC</c>
...
/// <see cref="IParserHost.SyntaxConstructor"/>, the RAG5 precedent — because the
/// call happens later, inside <c>partial-music-function</c>'s chain.
/// </content>
public static partial class LilyPondRuleActions
{
    private static void RegisterRag11(RuleActionTable table)
    {
        ...
        // list?. A bad property path from RAG7's grob_prop_path/context_prop_spec
