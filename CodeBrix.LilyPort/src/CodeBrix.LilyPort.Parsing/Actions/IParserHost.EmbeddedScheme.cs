...
/// <content>
/// The members the EmbeddedScheme group added: the parser's default-duration state.
/// </content>
public partial interface IParserHost
{
    ...
    /// rules (the PitchesAndDurations group) read and assign it too when they land.
