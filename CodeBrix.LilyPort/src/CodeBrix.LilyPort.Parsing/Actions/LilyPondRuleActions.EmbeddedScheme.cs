...
/// <content>
/// Embedded Scheme and embedded LilyPond:
...
{
    private static void RegisterEmbeddedScheme(RuleActionTable table)
    {
        ...
        //
        // Unlike toplevel_expression: SCM_TOKEN (the TopLevel group), which evaluates AND IGNORES,
