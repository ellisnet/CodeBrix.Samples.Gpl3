...
/// <content>
/// The members the MarkupStructure group (markup modes, lists and structure) added: the
...
public partial interface IParserHost
{
    ...
    /// <para>Upstream: <c>Lily_lexer::push_markup_state</c>. Like the LyricMode group's mode
    ...
    /// module <c>(lily)</c>) — the sibling of the ContextDefinitions group's <see cref="SyntaxConstructor"/>,
