...
/// <content>
/// Pitches, octaves and durations: <c>quotes</c> and its
...
/// <c>MakeChordElements</c>, which the MusicAssembly group ported whole with their defaulted C++
...
{
    private static void RegisterPitchesAndDurations(RuleActionTable table)
    {
