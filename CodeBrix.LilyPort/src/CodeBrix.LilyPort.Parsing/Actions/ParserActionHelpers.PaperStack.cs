...
/// actions (the BookBlocks group) drive: a <c>\book</c> body opens by resetting the
...
/// <c>paper_block</c> and <c>output_def_head</c> actions use — belongs to the OutputDefinitions group and is
