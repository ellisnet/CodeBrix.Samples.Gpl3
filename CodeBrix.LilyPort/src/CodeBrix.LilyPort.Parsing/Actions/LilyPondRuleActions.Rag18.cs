...
/// <content>
/// RULE ACTION GROUP 18 — the STRUCTURE of markup: the <c>\markup</c> and
...
/// (<see cref="ParserActionHelpers.MakeSimpleMarkup"/>, RAG15's identity).
/// </para>
/// <para>
...
{
    private static void RegisterRag18(RuleActionTable table)
    {
        ...
        // case, and a string IS a markup — RAG15's MakeSimpleMarkup, reused here as
        ...
        // arguments, which RAG19's argument rules accumulated in reverse.
        table.Add(
            "simple_markup_noword: MARKUP_FUNCTION markup_command_basic_arguments",
            (context, values, locations, location)
