...
/// <content>
/// RULE ACTION GROUP 5 — context definitions and modifications:
...
{
    private static void RegisterRag5(RuleActionTable table)
    {
        ...
        // it; contexted_basic_music (RAG6) finishes it with the music argument.
        table.Add(
            "context_prefix: CONTEXT symbol optional_id optional_context_mods",
            (context, values, locations, location)
                => Pair.List(
