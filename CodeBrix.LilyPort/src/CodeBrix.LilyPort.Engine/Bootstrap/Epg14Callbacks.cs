...
/// <summary>
/// The EPG14 entry points: scripts, dynamics, brackets, pedals, fingering, ledger lines
...
/// </para>
/// </remarks>
public static class Epg14Callbacks
{
    ...
    public static void Install(Interpreter interpreter)
    {
        ...
        // ----- line-interface-scheme.cc: PULLED FORWARD from EPG23 -----
        //
        // Forced by the demand loop, not chosen. `line-interface.cc` itself has been
        // ported since Wave A and EPG17 closed its last divergence, but its ONE Scheme
        ...
        // With EPG14's type-check fix letting that override reach the grob at last, the
    ...
    // skyline-scheme.cc and stencil-scheme.cc, PULLED FORWARD from EPG23 — forced, not
    // chosen. EPG14's own first sweep regressed 46 files, and the cause was EPG14 making
    ...
    private static void InstallDemandedLeafBindings(Interpreter interpreter)
    {
        ...
        // back the C# object instead is the mistake EPG4 recorded and it fails the same
        ...
        // note-head-scheme.cc, PULLED FORWARD from EPG23 for the same reason: note-head.cc
