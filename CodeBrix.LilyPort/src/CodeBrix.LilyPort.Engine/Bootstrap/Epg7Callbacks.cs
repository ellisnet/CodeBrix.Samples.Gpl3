...
/// <summary>
/// EPG7's Scheme surface: the vertical-organization callbacks — alignment, side
...
/// EPG15's pure/broken machinery, and a stub that reports demand is worth more than a
/// stand-in that hides it.
/// </para>
/// </summary>
public static class Epg7Callbacks
{
    ...
    /// <summary>
    /// The <c>axis-group-interface.cc</c> callbacks whose stubs EPG7's landing makes
    ...
    private static void InstallAxisGroupCallbacks(Interpreter interpreter)
    {
        ...
        // EMPTY staff — is deliberately unported (the EPG3 note), so this registers
    ...
    /// <summary>
    /// The pull-forwards: bindings from files owed by OTHER groups that EPG7's
