...
/// <summary>
/// The EPG18 entry points: the lyric extender and hyphen stencils, the two spacing-rod
...
/// </para>
/// </summary>
public static class Epg18Callbacks
{
    ...
    public static void Install(Interpreter interpreter)
    {
        ...
        // lily/grob-pq-engraver.cc's one LY_DEFINE, which comes with the engraver EPG18
        // pulled forward from EPG10 (standing rule 3: whoever ports a type owes its
    ...
    // lily/bezier-scheme.cc's SECOND binding, pulled forward from EPG23 under standing
    // rule 3. Flower's Bezier has been ported since the Flower milestone, so this surface
    // was owed from that day; it simply had no caller until EPG18's context-handle fix let
    ...
    // bindings-complete files EPG1 found sitting on the worklist.
