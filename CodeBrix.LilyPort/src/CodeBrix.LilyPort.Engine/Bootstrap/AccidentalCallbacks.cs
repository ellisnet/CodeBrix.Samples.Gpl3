...
/// <summary>
/// The accidental entry points: the accidental interface's grob callbacks, accidental
...
/// </para>
/// </summary>
public static class AccidentalCallbacks
{
    ...
    public static void Install(Interpreter interpreter)
    {
        ...
        // ly:grob::x-parent-positioning was pulled forward here by this group's demand
        ...
        // AccidentalPlacement.CalcPositioningDone). Vertical organization pulled the same binding —
        // and its y sibling — the same day; the single registration lives in
        // VerticalLayoutCallbacks over Objects/GrobClosure.cs.
    }
