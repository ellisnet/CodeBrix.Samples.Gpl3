...
/// <summary>
/// EPG16's Scheme surface: the six page-breaking strategies, the <c>Paper_book</c>
...
/// </para>
/// </remarks>
public static class Epg16Callbacks
{
    /// <summary>Registers EPG16's bindings.</summary>
    ...
    public static void Install(Interpreter interpreter)
    {
        ...
        // since EPG3 — this one binding was simply absent, and nothing noticed because
