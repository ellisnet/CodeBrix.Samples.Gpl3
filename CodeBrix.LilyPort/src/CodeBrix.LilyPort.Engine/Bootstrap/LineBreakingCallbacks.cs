...
/// <summary>
/// The line-breaking and broken-spanner entry points.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
public static class LineBreakingCallbacks
{
    ...
    public static void Install(Interpreter interpreter)
    {
        ...
        //
        // FORCED FORWARD from the long-tail pool by this group's own demand loop, the same
        // way stencil-scheme.cc's five leaves came forward with scripts/dynamics: the
        // file keeps its long-tail disposition and only the leaves the pure path asks
        // for land here.
        //
        ...
        //
        // ly:grob-pure-height REPLACES the earlier stand-in, which answered grob.Extent: an
