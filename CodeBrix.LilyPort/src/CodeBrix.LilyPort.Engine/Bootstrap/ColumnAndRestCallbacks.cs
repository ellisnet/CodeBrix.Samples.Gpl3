...
/// <summary>
/// The Scheme entry points the column and rest files declare: columns, rests, dots and collisions.
/// <para>
...
/// </para>
/// <para>
/// Four entry points from OTHER groups' files are pulled forward here because this group's
/// code paths are the first to need them, the same precedent as horizontal spacing's
...
/// <c>ly:unpure-call</c> / <c>ly:pure-call</c> (lily/unpure-pure-container.cc —
/// the vendored <c>grob::compose-function</c> calls them, and Rest_collision's chained
/// Y-offset goes through it).
/// </para>
/// </summary>
public static class ColumnAndRestCallbacks
{
