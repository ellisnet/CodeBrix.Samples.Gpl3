...
/// <summary>
/// The 391 predefined CFF strings, in SID order.
/// <para>
/// New-in-family, transcribed from the CFF specification (Adobe Technical Note
/// #5176, Appendix A). A charset SID below 391 names one of these; anything higher
/// indexes the font's own string INDEX.
/// </para>
/// </summary>
public static class CffStandardStrings
{
    /// <summary>The predefined strings, indexed by SID.</summary>
