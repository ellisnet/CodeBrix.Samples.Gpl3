...
public partial class App : Application
{
    ...
    protected override void OnLaunched(LaunchActivatedEventArgs args)
    {
        ...
        //Window title tracks the shell's state (the Pinta.Brix chrome pattern);
        //  raised from the UI thread only
        Services.WindowChrome.TitleChanged += title => MainWindow.Title = title;
