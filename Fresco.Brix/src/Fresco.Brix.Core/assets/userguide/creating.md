...
By default, {appname} always creates one empty document, where you can start
...
You can type {key} to insert, in the document, the LilyPond version the
built-in engraver is compatible with.
