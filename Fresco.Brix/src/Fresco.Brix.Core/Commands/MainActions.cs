...
public sealed class MainActions : ActionCollection
{
    ...
    public AppAction ExportMusicXml { get; private set; }

    /// <summary>File &gt; Import/Export &gt; Export Audio.</summary>
    public AppAction ExportAudio { get; private set; }
    ...
    protected override void CreateActions()
    {
        ...
        ExportMusicXml = Add("export_musicxml").WithIcon("document-export");
        ExportAudio = Add("export_audio").WithIcon("document-export");
    ...
    public override void TranslateUI()
    {
        ...
        ExportMusicXml.Text = I18n.Get("Export Music&XML...");
        ExportMusicXml.ToolTip = I18n.Get("Export current document as MusicXML.");
        ExportAudio.Text = I18n.Get("Export Audio...");
        ExportAudio.ToolTip = I18n.Get("Export to different audio formats.");
