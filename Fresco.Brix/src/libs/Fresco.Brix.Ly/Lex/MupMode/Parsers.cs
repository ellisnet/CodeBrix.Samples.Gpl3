...
namespace Fresco.Brix.Ly.Lex.MupMode; //was previously: ly/lex/mup.py (parser classes);

// Modified by Jeremy Ellis - 2026 - as part of the Fresco.Brix port.

/// <summary>Parses MUP from the toplevel.</summary>
public class ParseMup : Lex.Parser
{
